            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: StreamBuilder<List<EventdetailsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<EventdetailsRecord> listViewEventdetailsRecordList =
                          snapshot.data!;
                      ...
                      return ListView.builder(
                        ...
                        itemCount: listViewEventdetailsRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewEventdetailsRecord =
                              listViewEventdetailsRecordList[listViewIndex];
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              Padding(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          await listViewEventdetailsRecord
                                              .reference
                                              .delete();
